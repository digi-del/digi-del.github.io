    ...
    <div className="flex h-screen w-full bg-white overflow-hidden">
      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center items-center p-6 sm:p-12 relative overflow-y-auto">
        <div className="w-full max-w-md space-y-6">
          ...
          <div className="text-left space-y-2">
            ...
            <p className="text-gray-500 text-sm">Log in to manage your purchases and sales.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-1">
              <div className="flex justify-between items-center">
                ...
                <Link href="/forgot-password" className="text-xs text-[#023347] hover:underline font-medium">
                  Forgot password?
                </Link>
              </div>
            ...
            <p className="text-center text-sm text-gray-500 mt-4">
              Don't have an account? <Link href="/signup" className="text-[#023347] font-bold hover:underline">Sign up</Link>
            </p>
          </form>
        </div>
      </div>

      {/* --- RIGHT SIDE: ARTWORK & CONTENT (Buyer + Seller Ecosystem) --- */}
      <div className="hidden lg:flex lg:w-1/2 bg-[#023347] relative items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-lg text-center px-8 text-white space-y-8">
          ...
          {/* Header Text - Connecting both worlds */}
          <div className="space-y-4">
            <h2 className="text-4xl font-bold tracking-tight leading-tight">
              Build Faster. Earn More.
            </h2>
            <p className="text-lg text-blue-100/80 font-light leading-relaxed">
              The complete ecosystem for developers. Buy high-quality assets to accelerate your projects, or sell your code to a global audience.
            </p>
          </div>

          {/* DUAL CARD VISUAL: Representing the Ecosystem */}
          <div className="relative h-48 w-full max-w-[340px] mx-auto mt-8">
            
            {/* CARD 1: THE BUYER (Top Left - Floating) */}
            <div className="absolute top-0 left-0 z-20 w-64 bg-white/10 backdrop-blur-md border border-white/20 p-4 rounded-xl shadow-2xl -rotate-3 animate-pulse-slow">
              <div className="flex items-center gap-3 mb-2">
                ...
                <div className="text-left">
                  <p className="text-xs text-blue-200 uppercase font-bold tracking-wider">Asset Acquired</p>
                  <p className="text-sm font-semibold text-white">SaaS Starter Kit</p>
                </div>
              </div>
              <div className="bg-black/20 rounded-lg px-3 py-1.5 flex justify-between items-center">
                <span className="text-[10px] text-gray-300">Time Saved</span>
                <span className="text-xs font-bold text-green-300">~40 Hours</span>
              </div>
            </div>

            {/* CARD 2: THE SELLER (Bottom Right - Floating) */}
            <div className="absolute bottom-0 right-0 z-10 w-64 bg-[#034259] border border-blue-400/30 p-4 rounded-xl shadow-xl rotate-3">
              <div className="flex items-center gap-3 mb-2">
                ...
                <div className="text-left">
                  <p className="text-xs text-blue-200 uppercase font-bold tracking-wider">New Sale</p>
                  <p className="text-sm font-semibold text-white">React UI Library</p>
                </div>
              </div>
              <div className="flex justify-between items-center border-t border-white/5 pt-2 mt-1">
                <span className="text-[10px] text-gray-300">Earnings</span>
                <span className="text-sm font-bold text-teal-300">+$49.00</span>
              </div>
            </div>
